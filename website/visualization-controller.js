...
document.addEventListener('DOMContentLoaded', function() {
  ...
  (function patchSlideshow() {
    ...
    if (originalSlideshow) {
      ...
      // Add this script after the slideshow script has loaded
      originalSlideshow.onload = function() {
        head.appendChild(script);
      };
      
      // If the slideshow is already loaded, add the script now
      if (originalSlideshow.readyState === 'complete' || originalSlideshow.readyState === 'loaded') {
        head.appendChild(script);
      }
    }
  })();